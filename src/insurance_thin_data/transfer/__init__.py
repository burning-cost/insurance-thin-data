"""
insurance_thin_data.transfer: Transfer learning for thin-segment insurance pricing.
...
from insurance_thin_data.transfer.shift import CovariateShiftTest, ShiftTestResult
